        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-4">
          ...
          {lead.contact_name ? (
            <>
              ...
              {(lead as any).contact_linkedin_url && (
                <p className="text-sm">
                  <span className="text-muted-foreground">LinkedIn:</span>{" "}
                  <a href={(lead as any).contact_linkedin_url} target="_blank" rel="noreferrer" className="text-primary hover:underline">View Profile</a>
                </p>
              )}
              {(lead as any).enrichment_source && (
                <p className="text-xs text-muted-foreground capitalize mt-2">Source: {(lead as any).enrichment_source}</p>
              )}
            </>
          ) : (
